...
ent-PosterContrabandAtmosiaDeclarationIndependence = Сургута не существует
    .desc = Данный плакат утверждает что такого города как Сургут никогда не существовало. Но мы то ведь знаем правду?
ent-PosterContrabandFunPolice = Шуты в СБ
    .desc = Плакат с критикой службы безопасности станции.
ent-PosterContrabandLustyExomorph = Пахотливая ксено дева
    .desc = Ксеносов запрягают в плуг! Во время то...
ent-PosterContrabandSyndicateRecruitment = Вступайте в Синдикат
    .desc = Увидьте галактику! Сокрушите коррумпированные мегакорпорации! Попадите за забор! Погодите, что?
...
ent-PosterContrabandGreyTide = Ejectido Argentino
    .desc = Когда плакаты, Макс?
...
ent-PosterContrabandRebelsUnite = Бунтари вместе...
    .desc = ...В укромном тёмном месте
ent-PosterContrabandC20r = C-20r
    .desc = Плакат, рекламирующий C-20r от Scarborough Arms.
ent-PosterContrabandHaveaPuff = Время дунут
    .desc = Да кому нужны лёгкие?
...
ent-PosterContrabandWehWatches = Weh Смотрит
    .desc = Плакат с изображением очаровательной зелёной ящерицы.
ent-PosterContrabandVoteWeh = Голосуйте за Man
    .desc = Стильный, яркий и хорошо иллюстрированный плакат нового за"Man"чательного" прогрессивного кандидата, который появится в этом избирательном сезоне.
...
ent-PosterContrabandEnlistGorlex = Идёт набор
    .desc = Идёт набор... За забор. Не верьте рекламе!
...
ent-PosterLegitHereForYourSafety = Зачем закон
    .desc = Плакат, восхваляющий службу безопасности станции. "Зачем закон когда я и сам знаю кого надо посадить?"
ent-PosterLegitNanotrasenLogo = Логотип Nanotrasen
    .desc = Плакат с изображением логотипа Nanotrasen. Они его хоть читали?
ent-PosterLegitCleanliness = Чистота
    .desc = Плакат, информирующий об опасности плохой гигиены. "Или мой руки, или отдай их мне!"
ent-PosterLegitHelpOthers = Не помогай окружающим
    .desc = Плакат, призывающий не помогать слабым. Во славу естественного отбора!
ent-PosterLegitBuild = Строй!
    .desc = Плакат, прославляющий команду инженеров. Кто-то видит здесь собаку.
ent-PosterLegitBlessThisSpess = БОЖЕ ОТСЕК ГОВНА
    .desc = Плакат, проклинающий этот отсек.
ent-PosterLegitScience = Хрень
    .desc = Плакат с изображением какой-то хрени.
...
ent-PosterLegitSpaceCops = Косможопы
    .desc = Плакат, рекламирующий телешоу "Космические жопы".
...
ent-PosterLegitHighClassMartini = Бокал мочи
    .desc = Вы делаете глоток из стакан. На вкус как моча.
ent-PosterLegitTheOwl = Сова
    .desc = Сова сделает всё возможное, чтобы защитить станцию. А вы?
ent-PosterLegitNoERP = ЕРП нет!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография не существуют. Да больно надо!
...
ent-PosterLegitSecWatch = СБ видит
    .desc = Плакат, напоминающий вам, что служба безопасности следит за каждым вашим шагом. 1984 vibes...
...
ent-PosterLegitMime = Мимский постмодерн
    .desc = Постмодернистское изображение мима, ну или часов? Всё равно превосходно! 
