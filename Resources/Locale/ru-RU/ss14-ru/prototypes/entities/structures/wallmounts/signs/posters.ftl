...
ent-PosterContrabandGreyTide = Радон
    .desc = Не будь как гондон, скушай радон!
...
ent-PosterLegitNoERP = Скажи "ДА" ЕРП!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография обязательны на станциях "Nanotrasen".
